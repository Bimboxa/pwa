...
function buildPolylineAnnotation(
  ...
  const annotation = {
    ...
    fillOpacity: template?.fillOpacity ?? null,
    strokeOpacity: template?.strokeOpacity ?? null,
    opacity: template?.opacity ?? null,
  ...
  if (allVctViTemplateIds.size > 0) {
    ...
    for (const angle of reentrantAngles) {
      ...
      outputAnnotations.push({
        ...
        fillOpacity: arTemplate?.fillOpacity ?? null,
        strokeOpacity: arTemplate?.strokeOpacity ?? null,
        opacity: arTemplate?.opacity ?? null,
