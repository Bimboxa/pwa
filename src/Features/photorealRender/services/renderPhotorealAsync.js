...
// Toggle visibility on all top-level scene children. The predicate decides
// whether the child should be rendered in this pass. Returns a restore()
// callback that puts the original visibility back.
