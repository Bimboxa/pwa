...
export default function PopperEditAnnotation({ viewerKey = null }) {
  ...
  const open =
    ...
    ["MARKER", "POINT", "DETAIL", "POLYLINE", "POLYGON", "IMAGE", "RECTANGLE", "STRIP", "LINEAR_LAYOUT", "BASE_MAP_LINK", "OBJECT_3D", "RULER", "REVOLUTION_AXIS", "REVOLUTION_AXIS_PLACEMENT"].includes(type) &&
