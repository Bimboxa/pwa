...
export default function LeftPanel() {
  ...
  return (
    <Box sx={{ display: "flex", zIndex: 2 }}>
      {!isFullScreen && selectedViewerKey !== "MAP" && selectedViewerKey !== "THREED" && selectedViewerKey !== "MESHES" && selectedViewerKey !== "PORTFOLIO" && selectedViewerKey !== "BASE_MAPS" && selectedViewerKey !== "LISTING" && selectedViewerKey !== "ADMIN" && (
